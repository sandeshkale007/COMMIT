...
/* Includes ------------------------------------------------------------------*/
#include "platform.h"
#include "../../../Utilities/misc/stm32_mem.h"       /* RADIO_MEMSET8 def in this file */
#include "../../../LoRaWAN/Target/mw_log_conf.h"     /* mw trace conf */
#include "../../../LoRaWAN/Target/radio_board_if.h"  /* low layer api (bsp) */
